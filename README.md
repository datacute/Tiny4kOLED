...
- Replaced Wire with [TinyWireM](https://github.com/adafruit/TinyWireM) (Digispark's Wire is a rename of TinyWireM, but Adafruit's includes a necessary bug fix.)
